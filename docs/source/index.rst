...
Application examples can be found on `Conformal Mappings with SymPy <https://github.com/zolabar/ConformalMappingSympy>`_ . Back to `Conformal-Mapps github repository <https://github.com/im-AMS/Conformal-Maps>`_ . The following figure illustrates the GUI for the deformation of a rectangular geometry.
